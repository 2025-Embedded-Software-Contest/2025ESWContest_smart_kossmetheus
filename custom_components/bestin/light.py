...
class BestinLight(BestinDevice, LightEntity):
    ...
    def state_parse(self, state: dict) -> bool:
        ...
        brightness = state["brightness"]  # ColorMode.BRIGHTNESS 대응
        color_temp = state["color_temp"]   # ColorMode.COLOR_TEMP 대응
    ...
    def brightness(self) -> Optional[int]:
        ...
        brightness_value = self._device_info.state["brightness"]  # ColorMode.BRIGHTNESS 키 사용
    ...
    def color_temp_kelvin(self) -> Optional[int]:
        ...
        color_temp_value = self._device_info.state["color_temp"]  # ColorMode.COLOR_TEMP 키 사용
    ...
    async def async_turn_on(self, **kwargs):
        ...
        if brightness:
            ...
            command_kwargs["brightness"] = brightness  # ColorMode.BRIGHTNESS 키 사용
        if color_temp:
            color_temp = self.convert_color_temp(color_temp, reverse=True)
            command_kwargs["color_temp"] = color_temp  # ColorMode.COLOR_TEMP 키 사용
